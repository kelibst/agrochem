...
import { CreateShopOwnerProfileData } from '@/types/firebase';

interface ShopOwnerRegisterScreenProps {
...
interface RegisterData {
  ...
  userData: CreateShopOwnerProfileData;
}
...
export const ShopOwnerRegisterScreen: React.FC<ShopOwnerRegisterScreenProps> = ({
  onRegister,
  onLogin,
  onBack,
}) => {
  ...
  const validateForm = () => {
    ...
    if (formData.yearsInBusiness && isNaN(Number(formData.yearsInBusiness))) {
      newErrors.yearsInBusiness = 'Years in business must be a number';
    }
  ...
  const handleRegister = () => {
    if (validateForm()) {
      const userData: CreateShopOwnerProfileData = {
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="flex-1 px-6">
          ...
          >
            ...
            <Text style={{ fontSize: 18, fontWeight: '600', color: theme.text }}>Shop Owner Registration</Text>
            <View className="w-10" />
          </Animated.View>
          ...
          >
            ...
            <Text style={{ fontSize: 24, fontWeight: 'bold', color: theme.text, marginBottom: 8 }}>Join as a Shop Owner</Text>
